      ...
      <div className="flex-1 flex items-center justify-center py-12">
        <div className="max-w-3xl w-full space-y-12 animate-fade-in">
          <div className="text-center space-y-6">
            <h1 className="text-6xl sm:text-7xl font-light tracking-tighter">
              Wake
            </h1>
            <p className="text-xl sm:text-2xl text-gray-600 font-light max-w-2xl mx-auto">
              Five minutes to prime your mind, sharpen your focus, and activate
              your body.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 sm:p-10 space-y-8">
            <div className="prose prose-gray max-w-none">
              <p className="text-lg leading-relaxed">
                Think of it as your cognitive ignition sequence—a brief,
                scientifically-informed warmup that leaves you ready to perform
                at your peak.
              </p>
            </div>
